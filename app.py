...
def index():
    ...
    driver = webdriver.Chrome(executable_path=os.environ.get("C:\\Users\\gsingh302\\OneDrive - DXC Production\\Desktop\\Market Pro\\Market Fm\\MarketMan\\chromedriver.exe"), chrome_options=chrome_options)
